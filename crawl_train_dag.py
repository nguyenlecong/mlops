...
def craw_stock_price(**kwargs):
    ...
    # url = "https://github.com/nguyenlch/MiAI_Stock_Predict/raw/master/stock_prices.json"
    print(url)
    ...
    stock_price_df.to_csv("/home/nguyenlc/stock_data/stock_price.csv", index=None)
    return True

def train_model():
    # Doc du lieu VCB 2009->2018
    dataset_train = pd.read_csv('/home/nguyenlc/stock_data/stock_price.csv')
    ...
    regressor.save("/home/nguyenlc/stock_data/stockmodel.h5")
    return True
...
def email():
    ...
    out_csv_file_path = '/home/nguyenlc/stock_data/stock_price.csv'
    
    message = Mail(
        from_email='ainoodle.tech@gmail.com',
        to_emails='nguyenlch@gmail.com;thang.nc@shb.com.vn',
